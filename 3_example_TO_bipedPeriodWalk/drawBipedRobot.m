...
% Plot the links:
plot(x([1,3,4]),y([1,3,4]),'LineWidth',4,'Color',colorStance);
plot(x(1:2),y(1:2),'LineWidth',4,'Color',colorTorso);
plot(x([1,5,6]),y([1,5,6]),'LineWidth',4,'Color',colorSwing);
