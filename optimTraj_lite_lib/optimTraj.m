...
%           Note: This sub-struct is limited by linear guess, which is
%           unsuitable for many non-convex problems, so it should be
%           improved to cover more cases. (Meng Xiang 2021/3/15)
%
%       .time = [1, nGridGuess]
