...
% % add check program by Meng Xiang 2021/3/15
% for i = 1:length(zGuess)
%     if zGuess(i) > zUpp(i) || zGuess(i) < zLow(i)
%         fprintf('====== Number %d out of range!!! ======\n', i);
%     end    
% end
...
% for i = 1:length(P.x0)
%     if P.x0(i) > P.ub(i) || P.x0(i) < P.lb(i)
%         fprintf('====== Number %d out of range!!! ======', i);
%     end    
% end
